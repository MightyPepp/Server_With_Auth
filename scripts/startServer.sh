...
/home/mighty-pepe/Desktop/Server_With_Auth/server/scripts/existanceCrtsAndKeys.sh
...
if [ -e /home/mighty-pepe/Desktop/Server_With_Auth/server/logs/log.txt ] && [ -s /home/mighty-pepe/Desktop/Server_With_Auth/server/logs/log.txt ]; then
  > /home/mighty-pepe/Desktop/Server_With_Auth/server/logs/log.txt
fi

# Третий этап: 
# Идём в директорию main.go и собираем бинарь сервера

cd /home/mighty-pepe/Desktop/Server_With_Auth/server/internal/cmd/api 
...
nohup ./srv > /home/mighty-pepe/Desktop/Server_With_Auth/server/logs/log.txt 2>&1 &